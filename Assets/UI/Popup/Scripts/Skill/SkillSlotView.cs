...
{
    /// <summary>
    /// 스킬 장착 슬롯 뷰. 잠금, 빈 슬롯, 장착됨 세 가지 상태를 표시한다.
    /// </summary>
    public class SkillSlotView : MonoBehaviour
    {
        [SerializeField] private Image _iconImage;
        [SerializeField] private GameObject _lockedOverlay;
        // TODO: 해금 조건은 일단 여기로 받고 나중엔 터치 시 토스트 메세지를 띄워주는 방식으로 구현할것임.
        ...
        /// <summary>
        /// 슬롯에 스킬이 장착된 상태로 설정한다. 아이콘, 등급 배경색, 레벨을 표시한다.
        /// </summary>
        /// <param name="icon">스킬 아이콘 스프라이트</param>
        /// <param name="gradeColor">등급 배경 색상</param>
