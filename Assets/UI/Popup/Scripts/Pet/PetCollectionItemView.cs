...
{
    /// <summary>
    /// 펫 도감 그리드의 셀 뷰. 장착중, 잠금(미보유), 보통 세 가지 상태를 표시한다.
    /// </summary>
    public class PetCollectionItemView : MonoBehaviour
    {
        ...
        /// 셀의 펫 ID를 설정한다.
        /// </summary>
        /// <param name="petId">표시할 펫 ID</param>
