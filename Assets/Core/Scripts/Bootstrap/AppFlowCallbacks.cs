...
namespace IdleRPG.Core
{
    ...
    public class AppFlowCallbacks
    {
        ...
        /// <summary>Authentication 상태 진입 시 실행할 액션</summary>
        public Action OnAuthenticationEnter { get; set; }

        /// <summary>Authentication 상태에서 대기할 비동기 작업 (디바이스 인증, 서버 시간 동기화)</summary>
        public Func<UniTask> AuthenticationTask { get; set; } = () => UniTask.CompletedTask;

        /// <summary>Authentication 상태 퇴장 시 실행할 액션</summary>
        public Action OnAuthenticationExit { get; set; }
        ...
        /// <summary>오프라인 보상 표시 여부 판정</summary>
