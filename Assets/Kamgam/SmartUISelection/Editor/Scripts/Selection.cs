...
namespace Kamgam.SmartUISelection
{
    ...
    public static class Selection
    {
        ...
        private static void OnMouseUpInSceneView(Vector2 mousePosition, Event mouseEvent = null)
        {
            ...
            bool selectionBaseInvertKeyPressed = Event.current.keyCode == Settings.SelectionBaseToggleKeyCode 
                                                 || (Settings.SelectionBaseToggleKeyCode == KeyCode.LeftAlt && Event.current.modifiers == EventModifiers.Alt)
                                                 || (Settings.SelectionBaseToggleKeyCode == KeyCode.LeftControl && Event.current.modifiers == EventModifiers.Control);
            if ((!Settings.ignoreSelectionBaseAttributes && !selectionBaseInvertKeyPressed) || (Settings.ignoreSelectionBaseAttributes && selectionBaseInvertKeyPressed))
            {
